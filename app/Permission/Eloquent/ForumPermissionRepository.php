...
use Fourum\Model\Permission\ForumPermission;
...
class ForumPermissionRepository implements PermissionRepositoryInterface
{
    /**
     * @param string $name
    ...
    {
        $builder = ForumPermission::where('name', $name)->where($permissible->getForeignKey(), $permissible->getId());
