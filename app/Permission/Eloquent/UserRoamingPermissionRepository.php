...
use Fourum\Model\Permission\UserRoamingPermission;
...
class UserRoamingPermissionRepository implements PermissionRepositoryInterface
{
    /**
     * @param string $name
    ...
    {
        if ($permissive) {
            $builder = UserRoamingPermission::where('name', $name);
